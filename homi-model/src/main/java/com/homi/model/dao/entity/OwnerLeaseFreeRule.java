...
@TableName("owner_lease_free_rule")
@Schema(name = "OwnerLeaseFreeRule", description = "包租免租规则表")
public class OwnerLeaseFreeRule implements Serializable {
    @Serial
    ...
    @Schema(description = "计算方式：FIXED/RATIO")
