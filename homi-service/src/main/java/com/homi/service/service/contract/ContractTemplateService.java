...
public class ContractTemplateService {
    ...
    public byte[] previewContractTemplate(ContractTemplateQueryDTO query) {
        ...
        bill1.setUnpaidAmount(new BigDecimal(25850));
        ...
        feeList.add(new com.homi.model.tenant.vo.bill.LeaseBillFeeVO(
            1L, bill1.getId(), null, "RENTAL", null, "租金", new BigDecimal(15000), BigDecimal.ZERO, new BigDecimal(15000), 0,
            new Date(), new Date(), "租金"
        ));
        feeList.add(new com.homi.model.tenant.vo.bill.LeaseBillFeeVO(
            2L, bill1.getId(), null, "DEPOSIT", null, "押金", new BigDecimal(10000), BigDecimal.ZERO, new BigDecimal(10000), 0,
            new Date(), new Date(), "押金"
        ));
        feeList.add(new com.homi.model.tenant.vo.bill.LeaseBillFeeVO(
            3L, bill1.getId(), null, "OTHER_FEE", 1L, "物业费", new BigDecimal(200), BigDecimal.ZERO, new BigDecimal(200), 0,
            new Date(), new Date(), "物业费"
        ));
        feeList.add(new com.homi.model.tenant.vo.bill.LeaseBillFeeVO(
            4L, bill1.getId(), null, "OTHER_FEE", 2L, "服务费", new BigDecimal(650), BigDecimal.ZERO, new BigDecimal(650), 0,
