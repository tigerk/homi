...
//    private final PlatformUserService platformUserService;
     ...
     * @return com.nest.domain.vo.company.CompanyListVO
     */
    ...
    // todo 这个是给 nest 的 company 用的，需要调整调用方式，不能直接调用 companyRepo.updateById
...
//            platformUserService.updateUserStatusByCompanyId(company.getId(), StatusEnum.DISABLED.getValue());
//        } else {
//            List<PlatformUser> companyPlatformUserByType = platformUserService.getCompanyUserByType(company.getId(), PlatformUserTypeEnum.REGULAR_USER.getType());
//            if (companyPlatformUserByType.isEmpty()) {
//                throw new BizException("该公司下没有管理员，请先创建管理员");
//            }
//            PlatformUser platformUser = companyPlatformUserByType.getFirst();
//            platformUser.setStatus(StatusEnum.ACTIVE.getValue());
...
//    }
    ...
    public void deleteCompany(CompanyDeleteDTO deleteDTO) {
        companyRepo.getBaseMapper().deleteById(deleteDTO.getId());
    }
